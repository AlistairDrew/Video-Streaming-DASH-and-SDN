...
sudo x264 --output video_1200k.264 --fps 30 --bitrate 1200 --video-filter resize:width=1280,height=720 tvideo.mp4
...
sudo x264 --output video_2400k.264 --fps 30 --bitrate 2400 --video-filter resize:width=1280,height=720 tvideo.mp4
...
sudo x264 --output video_600k.264 --fps 30 --bitrate 600 --video-filter resize:width=1280,height=720 tvideo.mp4
...
cat video_1400k_dash_mpd >> test.mpd 
su adrew 
